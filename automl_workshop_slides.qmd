...
-   Slides are available at:
    ...
    <https://lucahuesler.github.io/automl_workshop/automl_workshop_slides.html>

-   Access RStudio Server via [rstudio.automl-workshop.ch](http://rstudio.automl-workshop.ch/)
...
AutoML tries to automate the process (or at least parts of it):
...
::: r-stack
![AutoML platforms (Source: Datasolut)](figures/automl-plattformen.png){.fragment fig-align="center"}

![AutoML tools (Source: ISG Siegen)](figures/AutoML-Tools-and-Libraries-Logos.png){.fragment fig-align="center"}
:::

::: notes
Here, you can see a timeline of AutoML platforms. H2O, the one that we will be using today, was one of the first platforms offering AutoML and then, more and more others and especially the giants like Google and Amazon also started to integrate AutoML.

...and when you search for AutoML nowadays, you get something like this.
:::
...
Transform data to a h2o dataframe
